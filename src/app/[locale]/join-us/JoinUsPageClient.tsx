...
const distributorTypes = [
  {
    ...
    description:
      'Stock Salaam Cola in your store, supermarket, or convenience outlet. Join our growing network of retail partners.',
  ...
  },
  {
    ...
    description:
      'Serve Salaam Cola in your restaurant, cafe, or food service business. Perfect for F&B establishments.',
  ...
  },
  {
    ...
    description:
      'Bulk orders for events, offices, or corporate gifting. Make a statement with purpose-driven refreshments.',
...
export function JoinUsPageClient() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Join the <span className="text-salaam-red-500">Movement</span>
            </motion.h1>
          ...
          >
            ...
            <motion.div variants={fadeInLeft} className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Build Your Career With Us</h2>
              </div>
              <p className="text-gray-600 leading-relaxed text-lg">
                Join a team that's making a difference. At Salaam Cola, we're not just selling beverages – we're
                building a movement for ethical consumption.
              </p>
              <p className="text-gray-600 leading-relaxed">
                We're always looking for passionate individuals who share our values and want to contribute to
                something meaningful. Whether you're in sales, marketing, operations, or logistics, we'd love to hear
                from you.
              </p>
            ...
            <motion.div variants={fadeInRight}>
              <GlassCard className="bg-white shadow-xl">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Send Your CV</h3>
      ...
      <section className="py-20 bg-salaam-red-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white">Have Questions?</h2>
            <p className="text-white/80 max-w-xl mx-auto">
              Our team is ready to assist with any inquiries about distribution, partnerships, or career
              opportunities.
            </p>
            <a
