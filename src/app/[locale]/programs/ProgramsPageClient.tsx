...
import { Heart, Globe, Users, HandHeart, Building, ArrowRight, Sparkles } from 'lucide-react'
...
const malaysiaPrograms = [
  {
    ...
    description:
      'We hit up the spots where the next generation chills, bringing the vibe and free cold colas to the youth.',
  },
  {
    icon: Building,
    title: 'Mosques & Orphanages',
    description:
      "From Iftar at the Masjid to weekend visits at orphanages, we're there to share a meal, a drink, and a smile.",
  },
  {
    icon: HandHeart,
    title: 'Grassroots Giving',
    description:
      'We don\'t wait for a "campaign." If there\'s a community that needs a boost, we load up the van and go.',
  },
]
...
export function ProgramsPageClient() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Where Your <span className="text-salaam-red-500">Sip Goes</span>
            </motion.h1>
      ...
      <section className="py-10 md:py-12 bg-gray-50/80" aria-label="Salaam Charity Tahfiz">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            variants={fadeInUp}
            initial="hidden"
          ...
          >
            <motion.div variants={fadeInLeft} className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Global Mission</h2>
              </div>
              <p className="text-gray-600 leading-relaxed text-lg">
                While others stay silent, we act. We aren't just "raising awareness"—we're sending real aid where it's
                needed most.
              </p>
              <p className="text-gray-600 leading-relaxed">
                10% of each can, a significant portion of our profits goes directly to Muslim countries to provide
            ...
            <motion.div variants={fadeInRight}>
              <div className="relative aspect-square rounded-3xl overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p className="text-white text-lg font-medium">Making a difference, one sip at a time</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center space-y-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">MALAYSIA: SERVING THE HOME TEAM</h2>
              <p className="text-gray-600 max-w-3xl mx-auto">
                We believe refreshment should be shared. We're taking the "Salaam Spirit" across Malaysia, showing up
                where it matters most:
              </p>
            </motion.div>

            <motion.div variants={staggerContainer} className="grid md:grid-cols-3 gap-6">
              {malaysiaPrograms.map((program) => (
            ...
            <motion.div variants={fadeInUp} className="text-center pt-8">
              <p className="text-xl md:text-2xl font-semibold text-gray-900">This isn't just charity. It's a community.</p>
              <p className="text-lg text-salaam-red-500 font-medium mt-2">Now you know where your sip goes.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-salaam-red-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white">Learn More About Our Global Impact</h2>
            <p className="text-white/80 max-w-xl mx-auto">
              Discover how Salaam Cola is making a difference in communities around the world through our parent
              company's charity initiatives.
            </p>
            <a
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Want to Partner With Us?</h2>
            <p className="text-gray-600">
              Whether you're a retailer, business, or individual looking to make a difference, we'd love to hear from
              you.
            </p>
            <Link
              href="/join-us"
