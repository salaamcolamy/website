    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              We'd Love to <span className="text-salaam-red-500">Hear from You</span>
            </motion.h1>
            ...
            >
              Have questions, feedback, or just want to say hello? We're here and ready to help.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section id="store-locator" className="py-16 relative overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/ttt.jpg" alt="" fill className="object-cover" sizes="100vw" />
