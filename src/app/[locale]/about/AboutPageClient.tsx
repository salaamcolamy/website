    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Refreshing with <span className="text-salaam-red-500">Purpose</span>
            </motion.h1>
            ...
            >
              We're not just making cola. We're building a movement for ethical refreshment that empowers
              communities and delivers exceptional taste.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <motion.div variants={fadeInLeft} className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Salaam Cola is leading a new wave in Malaysia. We've combined a premium, craft-style taste with a
                mission to give back. Founded in the UK, Salaam Cola was born from a simple belief; that what you
                drink should be as ethical as it is delicious.
              </p>
              <p className="text-gray-600 leading-relaxed">
                For the conscious drinker who refuses to settle, we offer a drink that's high in quality and heavy
                on heart. It's the familiar taste you love, crafted for a world that deserves more.
              </p>
            ...
            <motion.div variants={fadeInRight}>
              <div className="relative aspect-square rounded-3xl overflow-hidden">
                <Image src="/images/image-gen (13).jpg" alt="Our Story" fill className="object-cover" />
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center space-y-4">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">From a bold idea to a growing movement</p>
            </motion.div>
      ...
      <section className="py-20 bg-salaam-red-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white">Ready to Taste the Freedom?</h2>
